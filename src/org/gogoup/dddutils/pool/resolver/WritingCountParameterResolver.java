...
public class WritingCountParameterResolver extends TransientParameterResolver{
	...
	public boolean setParameter(ParameterPool pool, String name, Object value) {
		...
		if(null != this.parameterTable.get(name)
				&& this.parameterTable.get(name).equals(value)) return false;
	...
	@Override
	public String[] getParameterNames(ParameterPool pool) {return nameArray;}
