...
/**
 * ParameterPool is an aggregator class, in which all parameters must be
 * accessed via associated ParameterResolvers.
 * 
 * @author ruisun
 * 
 */
public interface ParameterPool {
     ...
     * @param value
     *            Object
     * @return boolean return false if the parameter value failed to set,
     ...
     * 
     * Different ParameterResolvers may have different way to process the query
     * request.
     * 
     * @param query
     *            String
     ...
     * @param name
     *            String
     * @return boolean Return true if the parameter is not persistentable,
