...
public class InMemoryAppSessionSPResolver extends AppServiceResolver {
	...
	public InMemoryAppSessionSPResolver(AppSessionContext sessionContext) {
	...
	protected AppService getAppService(AppSessionContext context,
		...
		{				
			return new InMemoryAppSessionSP();
		}
		return null;
	}
