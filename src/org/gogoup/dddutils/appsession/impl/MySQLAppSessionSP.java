...
public class MySQLAppSessionSP implements AppService, AppSessionSPI {
    ...
    public boolean hasSession(String applicationId, String sessionKey) {
        ...
        try {
            conn = (Connection) this.getSessionContext().getSession()
                    .getParameter(MySQLAppSessionSP.DB_CONN_NAME);
    ...
    public void update(AppSessionOS os) {
        ...
        try {
            ...
            String json = new Gson().toJson(os.getStates(), new TypeToken<Map<String, Object>>() {
            }.getType());
    ...
    private static AppSessionOS assembleSession(ResultSet rs) throws SQLException {
        ...
        Map<String, Object> states = new Gson().fromJson(
                rs.getString("States"), new TypeToken<Map<String, Object>>() {}.getType());
        
        return new AppSessionOS(rs.getString("ApplicationId"), rs.getString("SessionKey"),
                states, new Date(rs.getLong("LastUpdateTime")));
