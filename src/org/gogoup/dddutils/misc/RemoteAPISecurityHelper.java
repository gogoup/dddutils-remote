...
public class RemoteAPISecurityHelper {
	...
	//private static final String CERTIFICATE_FILE = "BuzzSpot_Certificates.p12";
	...
	public static SSLContext getAPNServerSSLContext(String cert, String password) {		
		if(null == APNServerSSLContext)
		{
			try{
				...
				{
					System.out.println("HERE======>KEY STORE ALIAS: "+aliases.nextElement());
				}
				*/
				//Set up key manager factory to use our key store
	...
	private static class RemoteAPISecurityTrustManager implements X509TrustManager {
		...
		public void checkClientTrusted(X509Certificate[] arg0, String arg1)
			...
			System.err.println("UNKNOWN CLIENT CERTIFICATE: " + arg0[0].getSubjectDN()+"<Thread: "+Thread.currentThread()+"; Time: "+System.currentTimeMillis()+">");						
		}
		...
		public void checkServerTrusted(X509Certificate[] arg0, String arg1)
			...
			System.err.println("UNKNOWN SERVER CERTIFICATE: " + arg0[0].getSubjectDN()+"<Thread: "+Thread.currentThread()+"; Time: "+System.currentTimeMillis()+">");			
		}
